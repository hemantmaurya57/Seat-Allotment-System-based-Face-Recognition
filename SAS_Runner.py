    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/heman/PycharmProjects/Seat Allotment system/Attendance/Manually Attendance/' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\heman\PycharmProjects\Seat Allotment system\Attendance\Manually '
                    r'Attendance\"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if conf < 50:
                            ...
                            global tt
                            tt = " Roll no "+str(Id) + " Name " + aa + " and Seat " + bb
                            En = '15624031' + str(Id)
                            attendance.loc[len(attendance)] = [Id, aa,bb,cc,dd,ee,ff,date, timeStamp]
                            cv2.rectangle(im, (x, y), (x + w, y + h), (0, 260, 0), 7)
                            cv2.putText(im, str(tt), (10, 180), font, 1, (255, 255, 0,), 4)
                ...
                root.configure(background='snow')
                cs = 'C:/Users/heman/PycharmProjects/Seat Allotment system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\heman\PycharmProjects\Seat Allotment system\Attendance"')
    ...
    def log_in():
        ...
        if username == 'SAS':
            if password == 'SAS@123':
                ...
                cs = 'C:/Users/heman/PycharmProjects/Seat Allotment system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
